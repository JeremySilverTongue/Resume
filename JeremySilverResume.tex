...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Package loading
\usepackage[letterpaper,left=12mm,right=12mm,top=9mm,bottom=0mm]{geometry}
...
\item Android, Google AppEngine, OpenGL/CL/CV.
\item Git, Mercurial, Gradle, Mathematica, MATLAB, LabVIEW, \LaTeX.
