...
\item Added Proto3 schemas and a gRPC interface to Stripe's streaming/batch computation platform, allowing for type-safe queries, while decresing bandwidth used.
\item Wrote tooling and microservices for filtering, searching, archiving, and replaying Kafka streams, making the team's day to day operations easier, and incident investigation and remediation quicker.
...
{
\item Created online courses that attracted over 27,000 students. Responsible for all stages of course creation: outlining, scripting, creating sample code and exercises, and finally appearing on camera.
